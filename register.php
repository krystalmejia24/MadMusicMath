...
<tr>
<form name="register" method="post" action="regresult.php">
<td>
...
<td width="6">:</td>
<td width="294"><input name="username" type="text" id="username" maxlength="128" pattern=".{1,}" required title="Required field"></td>
</tr>
<tr>
<td>Password</td>
<td>:</td>
...
<td>city</td>
<td>:</td>
<td><input name="city" type="text" id="city" maxlength="128"></td>
</tr>
<tr>
<td>D.O.B.</td>
<td>:</td>
<td><input name="DOB" type="text" id="DOB" placeholder="YYYY/MM/DD"></td>
</tr>
<tr>
<td>Ethnicity</td>
<td>:</td>
...
<option value="Caucasian (Other)">Caucasian (North African, Other)</option>
...
<option value="Pacific Islander">Pacific (Polynesian, Micronesian, etc)</option>
